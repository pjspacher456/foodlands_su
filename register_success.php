			...
			<h1>REGISTER SUCCESS</h1>
				<table style="border-spacing: 0 40px; position: absolute;">
					<tr class="all-td" style="position: absolute;left: 96px;">
						<td style="padding: 26px 257px;text-align: center;font-family: 'supermarketregular';background-color: #fff;"><h3 style="font-size:18px; color:#888888;">สมัครสมาชิกสำเร็จแล้ว</h3>
						<h5 style="font-size:14px; color:#888888;width: 300px;">แต่ขั้นตอนยังไม่เสร็จสมบูรณ์ คุณสามารถยืนยันการสมัครสมาชิกได้ที่ 
						<?php
							$a = $_SESSION["email"];
						...
						?>
						<?php echo $_SESSION["email"]; ?> </a>ค่ะ</h5>
						</td>
					</tr>
					<?php
					 $_SESSION["check"] = 2;
