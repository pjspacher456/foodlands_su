...
if(isset($_POST['submitted']))
{
   ...
   {
        $fgmembersite->RedirectToURL("about.php");
   }
}
?>
<!DOCTYPE html>
...
<header class="header">
		...
		<ul>
			...
			<a href="about.php"><li class="home activethis">
				<h3  style="color: #0b0b0b;font-family: 'dk_dirrrtyregular';font-size: 20px;"  >About us</h3>
			<h4 style="margin-top:0px;">เกี่ยวกับเรา</h4>
			</li></a>
			</ul>
			</div>
		<div id="menu-sign">
	...
	<div id="banner">
		<div id="about-align">
		<div class ="text-about-as">
			<h3><i class="fa fa-users" style="font-size:20px; color:#323746;">&nbsp&nbsp</i>About us</h3>
			<h4>เกี่ยวกับเรา</h4>
		</div>
		<div class="con">
		<div class="container-text">
			<div class="con-margin">
				<div class="text-about">
					<h3>ฟู๊ดแลนด์ แอท ศิลปากร</h3>
					<h5>ระบบสั่งอาหาร online เป็นระบบที่ทำงานในรูปแบบ Web site ทำให้ลูกค้าได้รับความสะดวกสะบายในการใช้งานหรือการสั่งอาหาร รวมถึงบริการจัดส่งอาหารถึงมือลูกค้า ทำให้ลูกค้าไม่เสียเวลาในการเดินทางสำหรับการสั่งอาหารถึงร้าน และยังสามารถจัดเก็บหลักฐานการสั่งอาหารที่เป็นแบบแผนมากขึ้น โดนข้อมูลจะถูกเก็บไว้ในระบบ ซึ่งลูกค้าสามารถเรียกดูได้ตลอดเวลา นอกจากนี้ลูกค้ายังสามารถสั่งอาหารจากหลายร้านค้าได้ในครั้งเดียว ทำให้ลูกค้ามีตัวเลือกในการทานอาหารมากขึ้น</h5>
					<h5>โดยรวบรวมรายการอาหารทุกร้านในรอบรั้วมหาวิทยาลัยศิลปากร วิทยาเขตสารสนเทศ เพชรบุรี ร้านที่ถูกรวบรวมมานั้นเป็นร้านอาหารที่มีคุณภาพ สะอาด ปลอดภัยและเป็นที่นิยมของชาวศิลปากร</h5>
					<h5>ผู้จัดทำ : 13570119 , 13570178 , 13570188 , 13570324</h5>
				</div>
			</div>
			<div class="while-logo">
				<div class="while-logo-img"></div>
			</div>
		</div><!-- container-text -->
		</div><!-- con -->
		</div>
