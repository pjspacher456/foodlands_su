...
<header class="header">
	...
	<div id="register" style="height: 412px;">
		<div class="register-box" style="height: 368px;">
			...
			<h1>ORDER ACTIVATE SUCCESS</h1>
				<table style="border-spacing: 0 40px; position: absolute;">
					<tr class="all-td" style="position: absolute;left: 96px;">
					<td style="padding: 26px 257px;text-align: center;font-family: 'supermarketregular';background-color: #fff;"><h3 style="font-size:18px; color:#888888;">เรากำลังจัดส่งอาหารถึงมือคุณ</h3>
						<h5 style="font-size:14px; color:#888888;width: 300px;">ขอบคุณที่ใช้บริการของ <a href="index.php" style="color:#f14949;">Foodsland @Silpakorn </a>ค่ะ </h5>
					<?php
					 $_SESSION["check"] = 3;
					 ?>
					 </td>
